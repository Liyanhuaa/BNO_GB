from util import *
from util import *
from torch.utils.data import DataLoader, TensorDataset, SequentialSampler, SubsetRandomSampler
...
#
    ...
    def get_examples_noise(self, processor, args, mode='train'):
        ...
        save_path = f"samples_{args.dataset}_{args.known_cls_ratio}_{args.open_noise_dataset}_{args.ind_noise_ratio}_{args.ood_noise_ratio}_{mode}_{args.ood_type}.csv"
        label_to_id = {label: idx for idx, label in enumerate(self.label_list)}
        with open(save_path, "w", newline="", encoding="utf-8") as csvfile:
            writer = csv.writer(csvfile)
