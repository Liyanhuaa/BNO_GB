...
def init_model():
    ...
    parser.add_argument("--bert_model",
                        default=r"E:\code_hh\PNGB\BNO_GB\uncased_L-12_H-768_A-12",
    ...
    parser.add_argument("--ind_noise_ratio", default=0.1, type=float, required=True,
                        help="The ratio of ind noise")
    parser.add_argument("--ood_noise_ratio", default=0.1, type=float, required=True,
    ...
    parser.add_argument("--step", default=5, type=int,
                        help="step of cluster.")


    parser.add_argument("--output_dir", type=str, default="E:\code_hh\PNGB\BNO_GB\outputs", help="Directory to save index files.")
    ...
    parser.add_argument("--purity_get_ball", default=0.7, type=int,
                        help="the purity of granular ball in get ball.")
    parser.add_argument("--purity_select_ball", default=0.7, type=int,
                        help="the purity of granular ball in select ball.")

    parser.add_argument("--min_ball_select_ball", default=5, type=int,
    ...
    parser.add_argument("--p_noise_ood", default=0.3, type=int,
                        help="granular ball smaller than it is ood ball.")
    parser.add_argument("--n_noise", default=5, type=int,
                        help=" granular ball smaller than it is ood ball")

    parser.add_argument("--warm_train_epoch", default=1, type=int,
    ...
    parser.add_argument("--GIND_p", default=0.25, type=float,
                        help="GIND_p")
    parser.add_argument("--SOOD_p", default=0.1, type=float,
                        help="SOOD_p")
    parser.add_argument("--len_to_split_ball", default=20, type=int,
                        help="len_to_split_ball")

    parser.add_argument("--num_train_epochs", default=100, type=float,
                        help="Total number of training epochs to perform.")
    parser.add_argument("--purity_select_ball_in_train", default=0.7, type=int,
                        help="the purity of granular ball in select ball.")
    parser.add_argument("--min_ball_select_ball_in_train", default=5, type=int,
                        help="the purity of granular ball in select ball in test.")
    return parser
